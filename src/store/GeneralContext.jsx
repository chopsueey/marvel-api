...
export function GeneralContext({ children }) {
  ...
  function searchHandler(e) {
    ...
    // insert all information in the searchUrl and make a switch case for different categories
    // const searchCategory = document.querySelector(".form-select").value;
    // console.log(searchCategory);

    // searchCategory === "comics" || "series" ? setStartsWith("titleStartsWith") : ("nameStartsWith");

    // `https://gateway.marvel.com/v1/public/${searchCategory}?ts=${timestamp}&apikey=${publicKey}&hash=${hash}&titleStartsWith${userSearch}&limit=${limit}`;
